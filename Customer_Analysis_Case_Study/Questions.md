1. I tried to use here (customer life time value type correction) method chaining but I had problems because pd.str only works with series with all items = str. Is there a work around to this?
